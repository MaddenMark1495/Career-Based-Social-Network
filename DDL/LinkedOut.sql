...
START TRANSACTION;
USE `linkedout`;
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`) VALUES (1, 'user', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'John', 'Smith', NULL, '1900-01-01', 'Columbia', 25);
