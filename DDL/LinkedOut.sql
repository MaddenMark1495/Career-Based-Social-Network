...
CREATE TABLE IF NOT EXISTS `linkedout`.`users` (
  ...
  `cur_title` VARCHAR(45) NULL,
  `cur_company` VARCHAR(45) NULL,
...
START TRANSACTION;
USE `linkedout`;
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`, `field`, `cur_title`, `cur_company`, `profile_views`, `summary`) VALUES (1, 'user', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'John', 'Smith', 'jsmith@gmail.com', '1900-01-01', 'Columbia', 25, 'Computer Science', 'Software Engineer', 'University of Missouri', 8, 'about those TPS reports');
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`, `field`, `cur_title`, `cur_company`, `profile_views`, `summary`) VALUES (11, 'user1', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'Natasha', 'Romanoff', 'blackwidow@avengers.com', '1984-11-22', 'New York', NULL, 'Super Hero', 'Black Widow', 'S.H.I.E.L.D./The Avengers', 5754, 'kicks ass and looks good doing it');
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`, `field`, `cur_title`, `cur_company`, `profile_views`, `summary`) VALUES (21, 'user2', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'Han', 'Solo', 'falcon@millenium.net', NULL, 'Outer Rim', NULL, 'Smuggling', 'Captain', 'self-employed', 1063, 'my son is super emo');
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`, `field`, `cur_title`, `cur_company`, `profile_views`, `summary`) VALUES (31, 'user3', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'Boba', 'Fett', 'slave1@hutt.org', NULL, NULL, NULL, 'Bounty Hunting', 'Bounty Hunter', 'contracted', 2843, 'my backpack\'s got jets');
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`, `field`, `cur_title`, `cur_company`, `profile_views`, `summary`) VALUES (41, 'user4', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'Obi-Wan', 'Kenobi', 'onlyhope@jedi.org', NULL, NULL, NULL, NULL, 'Force Ghost', '(deceased)', 54, NULL);
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`, `field`, `cur_title`, `cur_company`, `profile_views`, `summary`) VALUES (51, 'user5', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'Ren', '(unknown)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4197, 'looking for my daddy.. i think i may have found him on an island');
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`, `field`, `cur_title`, `cur_company`, `profile_views`, `summary`) VALUES (61, 'user6', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'Ben', 'Solo', 'emokid@starkiller.gov', NULL, NULL, NULL, NULL, NULL, NULL, 48, NULL);
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`, `field`, `cur_title`, `cur_company`, `profile_views`, `summary`) VALUES (71, 'user7', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'Chuck', 'Bartowski', 'c.bartowski@buymore.com', NULL, NULL, 5, 'Spy/Nerd', 'Intersect', 'CIA/NSA', 207, NULL);
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`, `field`, `cur_title`, `cur_company`, `profile_views`, `summary`) VALUES (81, 'user8', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'Peter', 'Quill', 'starlord@gotg.org', NULL, NULL, NULL, NULL, NULL, NULL, 2491, NULL);
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`, `field`, `cur_title`, `cur_company`, `profile_views`, `summary`) VALUES (91, 'user9', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'Tony', 'Stark', 'iamironman@avengers.com', NULL, 'New York', NULL, 'Peace in our Time', 'Iron Man', 'Stark Industries/The Avengers', 976, 'excels at Hulk smashing, j/k.. we\'re buds!');
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`, `field`, `cur_title`, `cur_company`, `profile_views`, `summary`) VALUES (101, 'user10', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'Thor', 'Son of Odin', 'thunderstruck@avengers.com', NULL, 'Asgard', NULL, 'Weilding Mjolnir', 'God of Thunder', 'Paul Mitchell/The Avengers', 638, 'yes.. Mjolnir is a hammer.  no.. i am not a carpenter');
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`, `field`, `cur_title`, `cur_company`, `profile_views`, `summary`) VALUES (111, 'user11', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'Steve', 'Rogers', 'cap@avengers.com', NULL, NULL, NULL, 'Shield Throwing Champion', 'Captain America', 'S.H.I.E.L.D./The Avengers', 25, 'seriously.. i can throw this thing so good...');
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`, `field`, `cur_title`, `cur_company`, `profile_views`, `summary`) VALUES (121, 'user12', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'Bruce', 'Banner', 'gammarays@avengers.com', NULL, NULL, NULL, 'Smashing', 'Incredible Hulk', 'The Avengers', 524, 'HULK SMASH!!!!');
INSERT INTO `linkedout`.`users` (`user_id`, `username`, `hashed_password`, `fname`, `lname`, `user_email`, `birthdate`, `city`, `state`, `field`, `cur_title`, `cur_company`, `profile_views`, `summary`) VALUES (131, 'user13', '$2y$10$oqkDqi7TY0ivbMAoJehnaOd3SfuzxMn1SL0sGKVkK3amSGXfJIG8m', 'Luke', 'Skywalker', 'lonelyjedi34@rebelalliance.org', NULL, 'Island Somewhere', NULL, 'Force Mastery', 'Last Jedi', 'unemployed', 681, 'i like long periods of isolation and staring into Rey\'s eyes for uncomfortably long periods of time');
...
INSERT INTO `linkedout`.`degree_type` (`deg_type_idx`, `degree_type_name`) VALUES (3, 'Master');
INSERT INTO `linkedout`.`degree_type` (`deg_type_idx`, `degree_type_name`) VALUES (4, 'PhD');
INSERT INTO `linkedout`.`degree_type` (`deg_type_idx`, `degree_type_name`) VALUES (5, 'MD');
INSERT INTO `linkedout`.`degree_type` (`deg_type_idx`, `degree_type_name`) VALUES (6, 'JD');
INSERT INTO `linkedout`.`degree_type` (`deg_type_idx`, `degree_type_name`) VALUES (7, 'MBA');
...
INSERT INTO `linkedout`.`education` (`user_id`, `education_entry`, `school`, `deg_type_idx`, `major_idx`, `start_year`, `end_year`) VALUES (1, 2, 'Harvard University', 3, 1, 2017, 2020);
